	...
	class WPEX_Custom_Login {
		...
		public function __construct() {
			...
			if ( is_admin() ) {
				...
				add_action( 'login_headerurl', array( 'WPEX_Custom_Login', 'login_headerurl' ) );
				add_filter( 'login_headertitle',array( 'WPEX_Custom_Login', 'login_headertitle' ) );
		 ...
		 * @since 4.5.4.2
		 */
		public static function login_headertitle( $title ) {
			$options = self::get_mods();
