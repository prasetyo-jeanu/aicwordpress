...
if ( ! class_exists( 'VCEX_Portfolio_Carousel_Shortcode' ) ) {
	...
	class VCEX_Portfolio_Carousel_Shortcode {
		...
		public static function map() {
			return array(
				'name' => __( 'Portfolio Carousel', 'total' ),
				'description' => __( 'Recent portfolio posts carousel', 'total' ),
				...
				'params' => array(
					...
					array(
						...
						'value' => '30',
						'description' => __( 'Enter how many words to display for the excerpt. To display the full post content enter "9999".', 'total' ),
						'group' => __( 'Excerpt', 'total' ),
