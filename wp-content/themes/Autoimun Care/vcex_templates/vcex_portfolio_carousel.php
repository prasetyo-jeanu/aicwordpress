					...
					if ( has_post_thumbnail() ) {
						...
						$media_output .= '<div class="' . esc_attr( $media_classes ) . '">';
							...
							elseif ( 'lightbox' == $thumbnail_link ) :
								...
								$media_output .= '<a href="' . wpex_get_lightbox_image() . '" title="' . $atts['post_esc_title'] . '" class="wpex-carousel-entry-img wpex-carousel-lightbox-item" data-count="' . $count . '" data-title="' . $atts['post_esc_title'] . '">';
