...
function thegem_shortcodes() {
	...
	$shortcodes = array(
		...
		'gem_news_grid' => array(
			'name' => __('Blog & News Extended Grid', 'thegem'),
			'base' => 'gem_news_grid',
			'icon' => 'thegem-icon-wpb-ui-news',
			'category' => __('The Gem', 'thegem'),
			'description' => __('News grid', 'thegem'),
			'params' => array_merge(array(
				array(
					'type' => 'dropdown',
					'heading' => __('Version', 'thegem'),
					'param_name' => 'news_grid_version',
					'value' => array(__('Default', 'thegem') => 'default', __('New', 'thegem') => 'new')
				),
				array(
					'type' => 'dropdown',
					'heading' => __('Layout', 'thegem'),
				...
				array(
					...
					array(
						...
						'group' => __('Colors', 'thegem'),
						'dependency' => array(
							'callback' => 'news_grid_colors_callback'
						),
					),
					array(
						'type' => 'colorpicker',
...
function thegem_news_grid_shortcode($atts) {
	extract(shortcode_atts(array(
		...
		'news_grid_background_style' => 'white',
		...
		'news_grid_likes' => false,
		'news_grid_sorting' => false,
		'news_grid_hide_date' => false,
		'news_grid_hide_categories' => false,
		'news_grid_hide_author_avatar' => false,
		'news_grid_hide_author' => false,
		'news_grid_hide_comments' => false,
