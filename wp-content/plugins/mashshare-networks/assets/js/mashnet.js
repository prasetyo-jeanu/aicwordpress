...
<div class="mashnet_pinterest_inner"></div>\n\
    ...
    for (i = 0; i < largeImages.length; i++){ 
     html += '<li><a target="_blank" id="mashnetPinterestPopup" href="https://pinterest.com/pin/create/button/?url='+window.location.href +'&media='+largeImages[i].src+'&description='+largeImages[i].alt+'"><img src="' + largeImages[i].src + '"></a></li>';
    }
    return html;
    }
});