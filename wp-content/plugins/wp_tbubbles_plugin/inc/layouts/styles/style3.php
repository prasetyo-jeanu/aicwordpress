<?php
	$html.='<div class="tmls_item" style="border-color:'.$border_color.';">
				...
				<div class="tmls_text dialog_box '.$dialog_radius.'" style="'.$text_font_family.' '.$text_font_color.' font-size:'.$text_font_size.'; background-color:'.$dialogbgcolor.'; border-color:'.$dialogbordercolor.';">'.$testimonial_text.'<span class="tmls_arrow">
