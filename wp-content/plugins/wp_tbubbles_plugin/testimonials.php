<?php
	/*
	Plugin Name: TBUBBLES - Testimonials WP
	Plugin URI: http://codecanyon.net/user/husamrayan
	Description: TBUBBLES - Testimonials WP.
	Version: 1.0
	Author: husamrayan
	*/
	...
	function tmls_register_my_custom_submenu_page() {
		...
		add_submenu_page( 'edit.php?post_type=tmls', 'Generate shortcode', 'Generate shortcode', 'edit_posts', 'post-new.php?post_type=tmls_sc' );
		
		// Saved Shortcodes Page
		add_submenu_page( 'edit.php?post_type=tmls', 'Saved Shortcodes', 'Saved Shortcodes', 'edit_posts', 'edit.php?post_type=tmls_sc' );
		
		// form (Generate Shortcode) Page
		add_submenu_page( 'edit.php?post_type=tmls', 'Submission form', 'Submission form', 'edit_posts', 'post-new.php?post_type=tmls_form_sc' );
		
		// form (Saved Shortcodes) Page
		add_submenu_page( 'edit.php?post_type=tmls', 'Saved forms', 'Saved forms', 'edit_posts', 'edit.php?post_type=tmls_form_sc' );
