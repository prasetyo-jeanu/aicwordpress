...
$(window).load(function(){
    ...
    tmls_logofailed_message = $('#tmls_logofailed_message');
	tmls_selectlogoagain_message = $('#tmls_selectlogoagain_message');
    ...
    tmls_logo_label_text = $('#tmls_logo_label_text');
    ...
    tmls_logo_options = $('.tmls_logo_option');
    ...
    if( tmls_logo.val() == 'disabled' ) {
		tmls_logo_options.slideUp('slow');
	}
	else {
		tmls_logo_options.slideDown('slow');
	}
...
function generate_shortcode() {
    ...
    postarray['logo'] = tmls_logo.val();
	shortcode+='logo="'+tmls_logo.val()+'" ';
    ...
    if(tmls_logo.val()=='enabled') {
		postarray['logofailed_message'] = tmls_logofailed_message.val();
		shortcode+='logofailed_message="'+tmls_logofailed_message.val()+'" ';
		
		postarray['selectlogoagain_message'] = tmls_selectlogoagain_message.val();
		shortcode+='selectlogoagain_message="'+tmls_selectlogoagain_message.val()+'" ';
	}
    ...
    if(tmls_logo.val()=='enabled') {
		postarray['logo_label_text'] = tmls_logo_label_text.val();
		shortcode+='logo_label_text="'+tmls_logo_label_text.val()+'" ';
	}
	...
	tmls_form_gene_short_preview.load('../wp-content/plugins/wp_tbubbles_plugin/inc/form_generate_shortcode/do_shortcode.php', postarray , function(){
