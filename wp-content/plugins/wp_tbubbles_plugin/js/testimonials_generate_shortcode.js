...
$(window).load(function(){
    ...
    tmls_usedimages = $('#tmls_usedimages');
    ...
    tmls_excerpttextlength = $('#tmls_excerpttextlength');
    ...
    tmls_slider2_imagesposition = $('#tmls_slider2_imagesposition');
	tmls_pagination = $('#tmls_pagination');
	tmls_pagination_border_style = $('#tmls_pagination_border_style');
	tmls_pagination_border_color = $('#tmls_pagination_border_color');
	tmls_pagination_bg_color = $('#tmls_pagination_bg_color');
	tmls_pagination_font_color = $('#tmls_pagination_font_color');
	tmls_pagination_font_size = $('#tmls_pagination_font_size');
	tmls_pagination_font_family = $('#tmls_pagination_font_family');
	tmls_pagination_current_font_color = $('#tmls_pagination_current_font_color');
	tmls_pagination_current_bg_color = $('#tmls_pagination_current_bg_color');
	tmls_pagination_current_border_color = $('#tmls_pagination_current_border_color');
	tmls_pagination_align = $('#tmls_pagination_align');
	tmls_pagination_divider_style = $('#tmls_pagination_divider_style');
	tmls_pagination_divider_color = $('#tmls_pagination_divider_color');
    tmls_morelinktext = $('#tmls_morelinktext');
    tmls_morelinktextcolor = $('#tmls_morelinktextcolor');
	...
	pagination_border_options = $('.pagination_border_option');
	pagination_divider_options = $('.pagination_divider_option');
	...
	if( tmls_layout.val() == 'tmls_slider' ) {
		...
		list_options.slideUp('slow');
		slider_options.slideDown('slow');
		pagination_options.slideUp('slow');
	}
		...
		if( tmls_pagination.val() == 'disabled' ) {
			pagination_options.slideUp('slow');
		}
		else {
			pagination_options.slideDown('slow');
			
			if( tmls_pagination_border_style.val() == 'none' ) {
				pagination_border_options.slideUp('slow');
			}
			
			if( tmls_pagination_divider_style.val() == 'none' ) {
				pagination_divider_options.slideUp('slow');
			}
		}
	}
	...
	// Pagination
	tmls_pagination.change(function(){
	...
	tmls_pagination_border_style.change(function(){
		
		if( tmls_pagination_border_style.val() == 'none' ) {
			pagination_border_options.slideUp('slow');
		}
		else {
			pagination_border_options.slideDown('slow');
		}
		
	});

	// Pagination Divider Style
	tmls_pagination_divider_style.change(function(){
		
		if( tmls_pagination_divider_style.val() == 'none' ) {
			pagination_divider_options.slideUp('slow');
		}
		else {
			pagination_divider_options.slideDown('slow');
		}
	...
	if( typeof jQuery.wp === 'object' && typeof jQuery.wp.wpColorPicker === 'function' ){
		...
		jQuery( '#tmls_pagination_border_color' ).wpColorPicker();
		jQuery( '#tmls_pagination_bg_color' ).wpColorPicker();
		jQuery( '#tmls_pagination_font_color' ).wpColorPicker();
		jQuery( '#tmls_pagination_current_font_color' ).wpColorPicker();
		jQuery( '#tmls_pagination_current_bg_color' ).wpColorPicker();
		jQuery( '#tmls_pagination_current_border_color' ).wpColorPicker();
		jQuery( '#tmls_pagination_divider_color' ).wpColorPicker();
        jQuery( '#tmls_morelinktextcolor' ).wpColorPicker();
		...
		jQuery('#tmls_pagination_border_color_colorpicker').farbtastic('#tmls_pagination_border_color');
		jQuery('#tmls_pagination_bg_color_colorpicker').farbtastic('#tmls_pagination_bg_color');
		jQuery('#tmls_pagination_font_color_colorpicker').farbtastic('#tmls_pagination_font_color');
		jQuery('#tmls_pagination_current_font_color_colorpicker').farbtastic('#tmls_pagination_current_font_color');
		jQuery('#tmls_pagination_current_bg_color_colorpicker').farbtastic('#tmls_pagination_current_bg_color');
		jQuery('#tmls_pagination_current_border_color_colorpicker').farbtastic('#tmls_pagination_current_border_color');
		jQuery('#tmls_pagination_divider_color_colorpicker').farbtastic('#tmls_pagination_divider_color');
        jQuery('#tmls_morelinktextcolor_colorpicker').farbtastic('#tmls_morelinktextcolor');
		
			
		tmls_farbtastic_inputs = $('#tmls_pagination_divider_color,#tmls_pagination_current_border_color,#tmls_pagination_current_bg_color,#tmls_pagination_current_font_color,#tmls_pagination_font_color,#tmls_pagination_border_color,#tmls_pagination_bg_color,#tmls_dialogBorderColor,#tmls_dialogBgColor,#tmls_text_font_color,#tmls_name_font_color,#tmls_position_font_color,#tmls_border_color,#tmls_ratingStarscolor,#tmls_next_prev_bgcolor,#tmls_slider2_unselectedOverlayBgColor,#tmls_morelinktextcolor');
...
function generate_shortcode() {
	...
	postarray['id'] = tmls_id.val();
	shortcode+='id="'+tmls_id.val()+'" ';
	...
	if( tmls_image_size.val()!='no_image' ) {
		postarray['usedimages'] = tmls_usedimages.val();
		shortcode+='usedimages="'+tmls_usedimages.val()+'" ';
    ...
    postarray['excerpttextlength'] = tmls_excerpttextlength.val();
	shortcode+='excerpttextlength="'+tmls_excerpttextlength.val()+'" ';
	...
	if( tmls_layout.val()=='tmls_slider2' ) {
        ...
        postarray['slider2_imagesposition'] = tmls_slider2_imagesposition.val();
		shortcode+='slider2_imagesposition="'+tmls_slider2_imagesposition.val()+'" ';
	}
	...
	if( tmls_pagination.val()=='enabled' ) {
		postarray['pagination'] = tmls_pagination.val();
		shortcode+='pagination="'+tmls_pagination.val()+'" ';
		
		postarray['pagination_border_style'] = tmls_pagination_border_style.val();
		shortcode+='pagination_border_style="'+tmls_pagination_border_style.val()+'" ';
		
		postarray['pagination_border_color'] = tmls_pagination_border_color.val();
		shortcode+='pagination_border_color="'+tmls_pagination_border_color.val()+'" ';
		
		postarray['pagination_bg_color'] = tmls_pagination_bg_color.val();
		shortcode+='pagination_bg_color="'+tmls_pagination_bg_color.val()+'" ';
		
		postarray['pagination_font_color'] = tmls_pagination_font_color.val();
		shortcode+='pagination_font_color="'+tmls_pagination_font_color.val()+'" ';
		
		postarray['pagination_font_size'] = tmls_pagination_font_size.val();
		shortcode+='pagination_font_size="'+tmls_pagination_font_size.val()+'" ';
		
		postarray['pagination_font_family'] = tmls_pagination_font_family.val();
		shortcode+='pagination_font_family="'+tmls_pagination_font_family.val()+'" ';
		
		postarray['pagination_current_font_color'] = tmls_pagination_current_font_color.val();
		shortcode+='pagination_current_font_color="'+tmls_pagination_current_font_color.val()+'" ';
		
		postarray['pagination_current_bg_color'] = tmls_pagination_current_bg_color.val();
		shortcode+='pagination_current_bg_color="'+tmls_pagination_current_bg_color.val()+'" ';
		
		postarray['pagination_current_border_color'] = tmls_pagination_current_border_color.val();
		shortcode+='pagination_current_border_color="'+tmls_pagination_current_border_color.val()+'" ';
		
		postarray['pagination_align'] = tmls_pagination_align.val();
		shortcode+='pagination_align="'+tmls_pagination_align.val()+'" ';
		
		postarray['pagination_divider_style'] = tmls_pagination_divider_style.val();
		shortcode+='pagination_divider_style="'+tmls_pagination_divider_style.val()+'" ';
		
		postarray['pagination_divider_color'] = tmls_pagination_divider_color.val();
		shortcode+='pagination_divider_color="'+tmls_pagination_divider_color.val()+'" ';
        
	}
    
    postarray['morelinktext'] = tmls_morelinktext.val();
    shortcode+='morelinktext="'+tmls_morelinktext.val()+'" ';
        
    postarray['morelinktextcolor'] = tmls_morelinktextcolor.val();
    shortcode+='morelinktextcolor="'+tmls_morelinktextcolor.val()+'" ';
	...
	tmls_gene_short_preview.load('../wp-content/plugins/wp_tbubbles_plugin/inc/testimonials_generate_shortcode/do_shortcode.php', postarray , function(){
