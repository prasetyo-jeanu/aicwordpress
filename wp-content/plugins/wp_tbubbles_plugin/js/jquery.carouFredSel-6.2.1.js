!function($) {
    ...
    function sc_fireCallbacks(t, e, s, i, n) {
        if (e[s] && e[s].call(t, i), n[s].length) for (var o = 0, r = n[s].length; r > o; o++) n[s][o].call(t, i);
        return [];
    }
    ...
    function sc_mapCallbackArguments(t, e, s, i, n, o, r) {
        return {
            width: r.width,
            height: r.height,
            items: {
    ...
    function sc_getDuration(t, e, s, i) {
        var n = t.duration;
        return "none" == t.fx ? 0 : ("auto" == n ? n = e.scroll.duration / e.scroll.items * s : 10 > n && (n = i / n), 
        1 > n ? 0 : ("fade" == t.fx && (n /= 2), Math.round(n)));
    }
    function nv_showNavi(t, e, s) {
        var i = is_number(t.items.minimum) ? t.items.minimum : t.items.visible + 1;
        if ("show" == e || "hide" == e) var n = e; else if (i > e) {
            debug(s, "Not enough items (" + e + " total, " + i + " needed): Hiding navigation.");
            var n = "hide";
        } else var n = "show";
        var o = "show" == n ? "removeClass" : "addClass", r = cf_c("hidden", s);
        t.auto.button && t.auto.button[n]()[o](r), t.prev.button && t.prev.button[n]()[o](r), 
        t.next.button && t.next.button[n]()[o](r), t.pagination.container && t.pagination.container[n]()[o](r);
    }
    function nv_enableNavi(t, e, s) {
        if (!t.circular && !t.infinite) {
            var i = "removeClass" == e || "addClass" == e ? e : !1, n = cf_c("disabled", s);
            if (t.auto.button && i && t.auto.button[i](n), t.prev.button) {
    ...
    function go_complementAutoObject(t, e) {
        return is_function(e.button) && (e.button = e.button.call(t)), is_string(e.button) && (e.button = $(e.button)), 
        is_boolean(e.play) || (e.play = !0), is_number(e.delay) || (e.delay = 0), is_undefined(e.pauseOnEvent) && (e.pauseOnEvent = !0), 
        is_boolean(e.pauseOnResize) || (e.pauseOnResize = !0), is_number(e.timeoutDuration) || (e.timeoutDuration = e.duration < 10 ? 2500 : 5 * e.duration), 
        e.progress && (is_function(e.progress.bar) && (e.progress.bar = e.progress.bar.call(t)), 
        is_string(e.progress.bar) && (e.progress.bar = $(e.progress.bar)), e.progress.bar ? (is_function(e.progress.updater) || (e.progress.updater = $.fn.carouFredSel.progressbarUpdater), 
    ...
    function go_complementPrevNextObject(t, e) {
        return is_function(e.button) && (e.button = e.button.call(t)), is_string(e.button) && (e.button = $(e.button)), 
        is_string(e.key) && (e.key = cf_getKeyCode(e.key)), e;
    }
    ...
    function go_complementPaginationObject(t, e) {
        return is_function(e.container) && (e.container = e.container.call(t)), is_string(e.container) && (e.container = $(e.container)), 
        is_number(e.items) || (e.items = !1), is_boolean(e.keys) || (e.keys = !1), is_function(e.anchorBuilder) || is_false(e.anchorBuilder) || (e.anchorBuilder = $.fn.carouFredSel.pageAnchorBuilder), 
    ...
    function go_complementSwipeObject(t, e) {
        return is_boolean(e.onTouch) || (e.onTouch = !0), is_boolean(e.onMouse) || (e.onMouse = !1), 
        is_object(e.options) || (e.options = {}), is_boolean(e.options.triggerOnTouchEnd) || (e.options.triggerOnTouchEnd = !1), 
        e;
    }
    ...
    function gn_getItemIndex(t, e, s, i, n) {
        if (is_string(t) && (t = $(t, n)), is_object(t) && (t = $(t, n)), is_jquery(t) ? (t = n.children().index(t), 
        is_boolean(s) || (s = !1)) : is_boolean(s) || (s = !0), is_number(t) || (t = 0), 
        is_number(e) || (e = 0), s && (t += i.first), t += e, i.total > 0) {
    ...
    function gn_getVisibleItemsPrev(t, e, s) {
        for (var i = 0, n = 0, o = s; o >= 0; o--) {
            var r = t.eq(o);
            if (i += r.is(":visible") ? r[e.d.outerWidth](!0) : 0, i > e.maxDimension) return n;
            0 == o && (o = t.length), n++;
        }
    }
    ...
    function gn_getItemsPrevFilter(t, e, s, i) {
        for (var n = 0, o = 0, r = i, a = t.length; r >= 0; r--) {
            if (o++, o == a) return o;
            var c = t.eq(r);
            if (c.is(e) && (n++, n == s)) return o;
            0 == r && (r = a);
        }
    }
    ...
    function gn_getVisibleItemsNext(t, e, s) {
        for (var i = 0, n = 0, o = s, r = t.length - 1; r >= o; o++) {
            var a = t.eq(o);
            if (i += a.is(":visible") ? a[e.d.outerWidth](!0) : 0, i > e.maxDimension) return n;
            if (n++, n == r + 1) return n;
            o == r && (o = -1);
        }
    }
    function gn_getVisibleItemsNextTestCircular(t, e, s, i) {
        var n = gn_getVisibleItemsNext(t, e, s);
        return e.circular || s + n > i && (n = i - s), n;
    }
    ...
    function gn_getItemsNextFilter(t, e, s, i, n) {
        for (var o = 0, r = 0, a = i, c = t.length - 1; c >= a; a++) {
            if (r++, r >= c) return r;
            var l = t.eq(a);
            if (l.is(e) && (o++, o == s)) return r;
            a == c && (a = -1);
        }
    }
    ...
    function sz_setResponsiveSizes(t, e) {
        var s = (t.items.visible, t.items[t.d.width]), i = t[t.d.height], n = is_percentage(i);
        e.each(function() {
            var e = $(this), o = s - ms_getPaddingBorderMargin(e, t, "Width");
            e[t.d.width](o), n && e[t.d.height](ms_getPercentage(o, i));
        });
    }
    function sz_setSizes(t, e) {
        var s = t.parent(), i = t.children(), n = gi_getCurrentItems(i, e), o = cf_mapWrapperSizes(ms_getSizes(n, e, !0), e, !1);
        if (s.css(o), e.usePadding) {
            var r = e.padding, a = r[e.d[1]];
            e.align && 0 > a && (a = 0);
            var c = n.last();
            c.css(e.d.marginRight, c.data("_cfs_origCssMargin") + a), t.css(e.d.top, r[e.d[0]]), 
            t.css(e.d.left, r[e.d[3]]);
        }
        return t.css(e.d.width, o[e.d.width] + 2 * ms_getTotalSize(i, e, "width")), t.css(e.d.height, ms_getLargestSize(i, e, "height")), 
        o;
    }
    ...
    function ms_getLargestSize(t, e, s, i) {
        return is_boolean(i) || (i = !1), is_number(e[e.d[s]]) && i ? e[e.d[s]] : is_number(e.items[e.d[s]]) ? e.items[e.d[s]] : (s = s.toLowerCase().indexOf("width") > -1 ? "outerWidth" : "outerHeight", 
        ms_getTrueLargestSize(t, e, s));
    }
    function ms_getTrueLargestSize(t, e, s) {
        for (var i = 0, n = 0, o = t.length; o > n; n++) {
            var r = t.eq(n), a = r.is(":visible") ? r[e.d[s]](!0) : 0;
            a > i && (i = a);
        }
        return i;
    }
    function ms_getTotalSize(t, e, s, i) {
        ...
        for (var n = s.toLowerCase().indexOf("width") > -1 ? "outerWidth" : "outerHeight", o = 0, r = 0, a = t.length; a > r; r++) {
            var c = t.eq(r);
    ...
    function ms_hasVariableSizes(t, e, s) {
        for (var i = !1, n = !1, o = 0, r = t.length; r > o; o++) {
            var a = t.eq(o), c = a.is(":visible") ? a[e.d[s]](!0) : 0;
            i === !1 ? i = c : i != c && (n = !0), 0 == i && (n = !0);
        }
        return n;
    }
    ...
    function cf_e(t, e, s, i, n) {
        return is_boolean(s) || (s = !0), is_boolean(i) || (i = !0), is_boolean(n) || (n = !1), 
        s && (t = e.events.prefix + t), i && (t = t + "." + e.events.namespace), i && n && (t += e.serialNumber), 
        t;
    }
    function cf_c(t, e) {
    ...
    function cf_mapWrapperSizes(t, e, s) {
        is_boolean(s) || (s = !0);
        var i = e.usePadding && s ? e.padding : [ 0, 0, 0, 0 ], n = {};
        return n[e.d.width] = t[0] + i[1] + i[3], n[e.d.height] = t[1] + i[0] + i[2], n;
    }
    function cf_sortParams(t, e) {
        for (var s = [], i = 0, n = t.length; n > i; i++) for (var o = 0, r = e.length; r > o; o++) if (e[o].indexOf(typeof t[i]) > -1 && is_undefined(s[o])) {
            s[o] = t[i];
            break;
        }
        return s;
    ...
    function cf_getDimensions(t) {
        for (var e = [ [ "width", "innerWidth", "outerWidth", "height", "innerHeight", "outerHeight", "left", "top", "marginRight", 0, 1, 2, 3 ], [ "height", "innerHeight", "outerHeight", "width", "innerWidth", "outerWidth", "top", "left", "marginBottom", 3, 2, 1, 0 ] ], s = e[0].length, i = "right" == t.direction || "left" == t.direction ? 0 : 1, n = {}, o = 0; s > o; o++) n[e[0][o]] = e[i][o];
        return n;
    }
    function cf_getAdjust(t, e, s, i) {
        var n = t;
        if (is_function(s)) n = s.call(i, n); else if (is_string(s)) {
            var o = s.split("+"), r = s.split("-");
    ...
    function cf_getItemAdjustMinMax(t, e) {
        return is_number(e.min) && t < e.min && (t = e.min), is_number(e.max) && t > e.max && (t = e.max), 
        1 > t && (t = 1), t;
    }
    function cf_getSynchArr(t) {
        is_array(t) || (t = [ [ t ] ]), is_array(t[0]) || (t = [ t ]);
        for (var e = 0, s = t.length; s > e; e++) is_string(t[e][0]) && (t[e][0] = $(t[e][0])), 
        is_boolean(t[e][1]) || (t[e][1] = !0), is_boolean(t[e][2]) || (t[e][2] = !0), is_number(t[e][3]) || (t[e][3] = 0);
        return t;
    }
    ...
    function in_mapCss(t, e) {
        for (var s = {}, i = 0, n = e.length; n > i; i++) s[e[i]] = t.css(e[i]);
        return s;
    }
    function in_complementItems(t, e, s, i) {
        return is_object(t.visibleConf) || (t.visibleConf = {}), is_object(t.sizesConf) || (t.sizesConf = {}), 
        0 == t.start && is_number(i) && (t.start = i), is_object(t.visible) ? (t.visibleConf.min = t.visible.min, 
        t.visibleConf.max = t.visible.max, t.visible = !1) : is_string(t.visible) ? ("variable" == t.visible ? t.visibleConf.variable = !0 : t.visibleConf.adjust = t.visible, 
        t.visible = !1) : is_function(t.visible) && (t.visibleConf.adjust = t.visible, t.visible = !1), 
        is_string(t.filter) || (t.filter = s.filter(":hidden").length > 0 ? ":visible" : "*"), 
        t[e.d.width] || (e.responsive ? (debug(!0, "Set a " + e.d.width + " for the items!"), 
        t[e.d.width] = ms_getTrueLargestSize(s, e, "outerWidth")) : t[e.d.width] = ms_hasVariableSizes(s, e, "outerWidth") ? "variable" : s[e.d.outerWidth](!0)), 
        t[e.d.height] || (t[e.d.height] = ms_hasVariableSizes(s, e, "outerHeight") ? "variable" : s[e.d.outerHeight](!0)), 
        t.sizesConf.width = t.width, t.sizesConf.height = t.height, t;
    }
    function in_complementVisibleItems(t, e) {
        ...
        t[t.d.width] = t.items.visible * t.items[t.d.width], t.items.visibleConf.adjust || (t.align = !1)), 
        ("Infinity" == t.items.visible || t.items.visible < 1) && (debug(!0, 'Not a valid number of visible items: Set to "variable".'), 
    ...
    function in_complementSecondarySize(t, e, s) {
        return "auto" == t && (t = ms_getTrueLargestSize(s, e, "outerHeight")), t || (t = e.items[e.d.height]), 
        t;
    }
    ...
    function bt_pauseOnHoverConfig(t) {
        if (is_string(t)) var e = t.indexOf("immediate") > -1 ? !0 : !1, s = t.indexOf("resume") > -1 ? !0 : !1; else var e = s = !1;
        return [ e, s ];
    }
    ...
    function debug(t, e) {
        if (!is_undefined(window.console) && !is_undefined(window.console.log)) {
            ...
            if (!t) return !1;
            e = is_string(e) ? "carouFredSel" + s + ": " + e : [ "carouFredSel" + s + ":", e ], 
    ...
    $.fn.carouFredSel || ($.fn.caroufredsel = $.fn.carouFredSel = function(options, configs) {
        ...
        FN._init = function(t, e, s) {
            t = go_getObject($tt0, t), t.items = go_getItemsObject($tt0, t.items), t.scroll = go_getScrollObject($tt0, t.scroll), 
            t.auto = go_getAutoObject($tt0, t.auto), t.prev = go_getPrevNextObject($tt0, t.prev), 
            t.next = go_getPrevNextObject($tt0, t.next), t.pagination = go_getPaginationObject($tt0, t.pagination), 
            t.swipe = go_getSwipeObject($tt0, t.swipe), t.mousewheel = go_getMousewheelObject($tt0, t.mousewheel), 
            e && (opts_orig = $.extend(!0, {}, $.fn.carouFredSel.defaults, t)), opts = $.extend(!0, {}, $.fn.carouFredSel.defaults, t), 
            opts.d = cf_getDimensions(opts), crsl.direction = "up" == opts.direction || "left" == opts.direction ? "next" : "prev";
            var i = $cfs.children(), n = ms_getParentSize($wrp, opts, "width");
            if (is_true(opts.cookie) && (opts.cookie = "caroufredsel_cookie_" + conf.serialNumber), 
            opts.maxDimension = ms_getMaxDimension(opts, n), opts.items = in_complementItems(opts.items, opts, i, s), 
            opts[opts.d.width] = in_complementPrimarySize(opts[opts.d.width], opts, i), opts[opts.d.height] = in_complementSecondarySize(opts[opts.d.height], opts, i), 
            ...
            opts[opts.d.width] = ms_getPercentage(n, crsl.primarySizePercentage), opts.items.visible || (opts.items.visibleConf.variable = !0)), 
            ...
            opts.items.visibleConf.variable && (opts.items.visible = gn_getVisibleItemsNext(i, opts, 0))), 
            "*" == opts.items.filter || opts.items.visibleConf.variable || (opts.items.visibleConf.org = opts.items.visible, 
            opts.items.visible = gn_getVisibleItemsNextFilter(i, opts, 0)), opts.items.visible = cf_getItemsAdjust(opts.items.visible, opts, opts.items.visibleConf.adjust, $tt0), 
            ...
            opts = in_getResponsiveValues(opts, i, n); else switch (opts.padding = cf_getPadding(opts.padding), 
            ...
            var t = $cfs.children(), e = in_mapCss($cfs, [ "textAlign", "float", "position", "top", "right", "bottom", "left", "zIndex", "width", "height", "marginTop", "marginRight", "marginBottom", "marginLeft" ]), s = "relative";
            switch (e.position) {
              case "absolute":
              case "fixed":
                s = e.position;
            ...
            FN._unbind_events(), $cfs.bind(cf_e("stop", conf), function(t, e) {
                return t.stopPropagation(), crsl.isStopped || opts.auto.button && opts.auto.button.addClass(cf_c("stopped", conf)), 
                crsl.isStopped = !0, opts.auto.play && (opts.auto.play = !1, $cfs.trigger(cf_e("pause", conf), e)), 
                !0;
                ...
                if (t.stopPropagation(), tmrs = sc_clearTimers(tmrs), e && crsl.isScrolling) {
                    ...
                    scrl.duration -= i, scrl.pre && (scrl.pre.duration -= i), scrl.post && (scrl.post.duration -= i), 
                    sc_stopScroll(scrl, !1);
                }
                if (crsl.isPaused || crsl.isScrolling || s && (tmrs.timePassed += getTime() - tmrs.startTime), 
                ...
                var n = [ e, s, i ], o = [ "string", "number", "boolean" ], r = cf_sortParams(n, o);
                if (e = r[0], s = r[1], i = r[2], "prev" != e && "next" != e && (e = crsl.direction), 
                is_number(s) || (s = 0), is_boolean(i) || (i = !1), i && (crsl.isStopped = !1, opts.auto.play = !0), 
                !opts.auto.play) return t.stopImmediatePropagation(), debug(conf, "Carousel stopped: Not scrolling.");
                ...
                var a = opts.auto.timeoutDuration + s;
                return dur2 = a - tmrs.timePassed, perc = 100 - Math.ceil(100 * dur2 / a), opts.auto.progress && (tmrs.progress = setInterval(function() {
                    ...
                    opts.auto.onTimeoutEnd && opts.auto.onTimeoutEnd.call($tt0, perc, dur2), crsl.isScrolling ? $cfs.trigger(cf_e("play", conf), e) : $cfs.trigger(cf_e(e, conf), opts.auto);
                }, dur2), opts.auto.onTimeoutStart && opts.auto.onTimeoutStart.call($tt0, perc, dur2), 
                !0;
            }), $cfs.bind(cf_e("resume", conf), function(t) {
                return t.stopPropagation(), scrl.isStopped ? (scrl.isStopped = !1, crsl.isPaused = !1, 
                crsl.isScrolling = !0, scrl.startTime = getTime(), sc_startScroll(scrl, conf)) : $cfs.trigger(cf_e("play", conf)), 
                !0;
            }), $cfs.bind(cf_e("prev", conf) + " " + cf_e("next", conf), function(t, e, s, i, n) {
                if (t.stopPropagation(), crsl.isStopped || $cfs.is(":hidden")) return t.stopImmediatePropagation(), 
                ...
                var r = [ e, s, i, n ], a = [ "object", "number/string", "function", "boolean" ], c = cf_sortParams(r, a);
                e = c[0], s = c[1], i = c[2], n = c[3];
                var l = t.type.slice(conf.events.prefix.length);
                if (is_object(e) || (e = {}), is_function(i) && (e.onAfter = i), is_boolean(n) && (e.queue = n), 
                e = $.extend(!0, {}, opts[l], e), e.conditions && !e.conditions.call($tt0, l)) return t.stopImmediatePropagation(), 
                debug(conf, 'Callback "conditions" returned false.');
                if (!is_number(s)) {
                    if ("*" != opts.items.filter) s = "visible"; else for (var f = [ s, e.items, opts[l].items ], c = 0, u = f.length; u > c; c++) if (is_number(f[c]) || "page" == f[c] || "visible" == f[c]) {
                        s = f[c];
                        break;
                    }
                    switch (s) {
                ...
                if (scrl.isStopped) return $cfs.trigger(cf_e("resume", conf)), $cfs.trigger(cf_e("queue", conf), [ l, [ e, s, i ] ]), 
                t.stopImmediatePropagation(), debug(conf, "Carousel resumed scrolling.");
                if (e.duration > 0 && crsl.isScrolling) return e.queue && ("last" == e.queue && (queu = []), 
                ("first" != e.queue || 0 == queu.length) && $cfs.trigger(cf_e("queue", conf), [ l, [ e, s, i ] ])), 
                t.stopImmediatePropagation(), debug(conf, "Carousel currently scrolling.");
                if (tmrs.timePassed = 0, $cfs.trigger(cf_e("slide_" + l, conf), [ e, s ]), opts.synchronise) for (var p = opts.synchronise, d = [ e, s ], g = 0, u = p.length; u > g; g++) {
                    var m = l;
                    p[g][2] || (m = "prev" == m ? "next" : "prev"), p[g][1] || (d[0] = p[g][0].triggerHandler("_cfs_triggerEvent", [ "configuration", m ])), 
                    d[1] = s + p[g][3], p[g][0].trigger("_cfs_triggerEvent", [ "slide_" + m, d ]);
                }
                return !0;
                ...
                if (sz_resetMargin(i, opts), !is_number(s)) {
                    if (opts.items.visibleConf.variable) s = gn_getVisibleItemsPrev(i, opts, itms.total - 1); else if ("*" != opts.items.filter) {
                        ...
                        s = gn_getScrollItemsPrevFilter(i, opts, itms.total - 1, n);
                    } else s = opts.items.visible;
                    s = cf_getAdjust(s, opts, e.items, $tt0);
                }
                if (opts.circular || itms.total - s < itms.first && (s = itms.total - itms.first), 
                opts.items.visibleConf.old = opts.items.visible, opts.items.visibleConf.variable) {
                    var o = cf_getItemsAdjust(gn_getVisibleItemsNext(i, opts, itms.total - s), opts, opts.items.visibleConf.adjust, $tt0);
                    opts.items.visible + s <= o && s < itms.total && (s++, o = cf_getItemsAdjust(gn_getVisibleItemsNext(i, opts, itms.total - s), opts, opts.items.visibleConf.adjust, $tt0)), 
                    opts.items.visible = o;
                } else if ("*" != opts.items.filter) {
                    var o = gn_getVisibleItemsNextFilter(i, opts, itms.total - s);
                ...
                opts.circular || (0 == itms.first && e.onEnd && e.onEnd.call($tt0, "prev"), opts.infinite || nv_enableNavi(opts, itms.first, conf)), 
                $cfs.children().slice(itms.total - s, itms.total).prependTo($cfs), itms.total < opts.items.visible + s && $cfs.children().slice(0, opts.items.visible + s - itms.total).clone(!0).appendTo($cfs);
                var i = $cfs.children(), r = gi_getOldItemsPrev(i, opts, s), a = gi_getNewItemsPrev(i, opts), c = i.eq(s - 1), l = r.last(), f = a.last();
                ...
                if (opts.items.visible < s && (_ = i.slice(opts.items.visibleConf.old, s), "directscroll" == e.fx)) {
                    ...
                    m = _, c = f, sc_hideHiddenItems(m), opts.items[opts.d.width] = "variable";
                }
                var b = !1, h = ms_getTotalSize(i.slice(0, s), opts, "width"), w = cf_mapWrapperSizes(ms_getSizes(a, opts, !0), opts, !opts.usePadding), S = 0, P = {}, x = {}, C = {}, y = {}, I = {}, z = {}, j = {}, k = sc_getDuration(e, opts, s, h);
                switch (e.fx) {
                  case "cover":
                  case "cover-fade":
                    S = ms_getTotalSize(i.slice(0, opts.items.visible), opts, "width");
                }
                m && (opts.items[opts.d.width] = v), sz_resetMargin(i, opts, !0), p >= 0 && sz_resetMargin(l, opts, opts.padding[opts.d[1]]), 
                u >= 0 && sz_resetMargin(c, opts, opts.padding[opts.d[3]]), opts.align && (opts.padding[opts.d[1]] = p, 
                opts.padding[opts.d[3]] = u), z[opts.d.left] = -(h - g), j[opts.d.left] = -(S - g), 
                x[opts.d.left] = w[opts.d.width];
                var N = function() {}, T = function() {}, O = function() {}, M = function() {}, F = function() {}, A = function() {}, H = function() {}, q = function() {}, D = function() {}, R = function() {}, V = function() {};
                switch (e.fx) {
                  case "crossfade":
                  case "cover":
                  case "cover-fade":
                ...
                if ($cfs.css(z), scrl = sc_setScroll(k, e.easing, conf), P[opts.d.left] = opts.usePadding ? opts.padding[opts.d[3]] : 0, 
                ("variable" == opts[opts.d.width] || "variable" == opts[opts.d.height]) && (N = function() {
                    $wrp.css(w);
                }, T = function() {
                    scrl.anims.push([ $wrp, w ]);
                }), opts.usePadding) {
                    switch (f.not(c).length && (C[opts.d.marginRight] = c.data("_cfs_origCssMargin"), 
                    0 > u ? c.css(C) : (H = function() {
                        c.css(C);
                    }, q = function() {
                        scrl.anims.push([ c, C ]);
                    })), e.fx) {
                      case "cover":
                      case "cover-fade":
                        b.children().eq(s - 1).css(C);
                    }
                    f.not(l).length && (y[opts.d.marginRight] = l.data("_cfs_origCssMargin"), O = function() {
                        l.css(y);
                    }, M = function() {
                        scrl.anims.push([ l, y ]);
                    }), p >= 0 && (I[opts.d.marginRight] = f.data("_cfs_origCssMargin") + opts.padding[opts.d[1]], 
                    F = function() {
                        f.css(I);
                    }, A = function() {
                        scrl.anims.push([ f, I ]);
                ...
                R = function() {
                    if (E > 0 && ($cfs.children().slice(itms.total).remove(), r = $($cfs.children().slice(itms.total - (opts.items.visible - E)).get().concat($cfs.children().slice(0, E).get()))), 
                    sc_showHiddenItems(m), opts.usePadding) {
                        var t = $cfs.children().eq(opts.items.visible + s - 1);
                        t.css(opts.d.marginRight, t.data("_cfs_origCssMargin"));
                    }
                };
                var W = sc_mapCallbackArguments(r, _, a, s, "prev", k, w);
                switch (D = function() {
                    sc_afterScroll($cfs, b, e), crsl.isScrolling = !1, clbk.onAfter = sc_fireCallbacks($tt0, e, "onAfter", W, clbk), 
                    queu = sc_fireQueue($cfs, queu, conf), crsl.isPaused || $cfs.trigger(cf_e("play", conf));
                }, crsl.isScrolling = !0, tmrs = sc_clearTimers(tmrs), clbk.onBefore = sc_fireCallbacks($tt0, e, "onBefore", W, clbk), 
                e.fx) {
                  case "none":
                    $cfs.css(P), N(), O(), F(), H(), V(), R(), D();
                    break;
                  ...
                  case "fade":
                    scrl.anims.push([ $cfs, {
                        ...
                        N(), O(), F(), H(), V(), R(), scrl = sc_setScroll(k, e.easing, conf), scrl.anims.push([ $cfs, {
                            opacity: 1
                  ...
                  case "uncover":
                    scrl.anims.push([ b, x, D ]), T(), O(), F(), H(), V(), R();
                    break;
                ...
                return sc_startScroll(scrl, conf), cf_setCookie(opts.cookie, $cfs, conf), $cfs.trigger(cf_e("updatePageStatus", conf), [ !1, w ]), 
                !0;
                ...
                if (sz_resetMargin(i, opts), !is_number(s)) {
                    if ("*" != opts.items.filter) {
                        var n = is_number(e.items) ? e.items : gn_getVisibleOrg($cfs, opts);
                        s = gn_getScrollItemsNextFilter(i, opts, 0, n);
                    } else s = opts.items.visible;
                    s = cf_getAdjust(s, opts, e.items, $tt0);
                }
                var o = 0 == itms.first ? itms.total : itms.first;
                if (!opts.circular) {
                    if (opts.items.visibleConf.variable) var r = gn_getVisibleItemsNext(i, opts, s), n = gn_getVisibleItemsPrev(i, opts, o - 1); else var r = opts.items.visible, n = opts.items.visible;
                    s + r > o && (s = o - n);
                }
                if (opts.items.visibleConf.old = opts.items.visible, opts.items.visibleConf.variable) {
                    for (var r = cf_getItemsAdjust(gn_getVisibleItemsNextTestCircular(i, opts, s, o), opts, opts.items.visibleConf.adjust, $tt0); opts.items.visible - s >= r && s < itms.total; ) s++, 
                    r = cf_getItemsAdjust(gn_getVisibleItemsNextTestCircular(i, opts, s, o), opts, opts.items.visibleConf.adjust, $tt0);
                ...
                opts.infinite || nv_enableNavi(opts, itms.first, conf)), itms.total < opts.items.visible + s && $cfs.children().slice(0, opts.items.visible + s - itms.total).clone(!0).appendTo($cfs);
                var i = $cfs.children(), a = gi_getOldItemsNext(i, opts), c = gi_getNewItemsNext(i, opts, s), l = i.eq(s - 1), f = a.last(), u = c.last();
                sz_resetMargin(i, opts);
                var p = 0, d = 0;
                if (opts.align) {
                ...
                var m = !1, _ = $();
                if (opts.items.visibleConf.old < s && (_ = i.slice(opts.items.visibleConf.old, s), 
                "directscroll" == e.fx)) {
                    var v = opts.items[opts.d.width];
                    m = _, l = f, sc_hideHiddenItems(m), opts.items[opts.d.width] = "variable";
                }
                var b = !1, h = ms_getTotalSize(i.slice(0, s), opts, "width"), w = cf_mapWrapperSizes(ms_getSizes(c, opts, !0), opts, !opts.usePadding), S = 0, P = {}, x = {}, C = {}, y = {}, I = {}, z = sc_getDuration(e, opts, s, h);
                switch (e.fx) {
                  case "uncover":
                  case "uncover-fade":
                    S = ms_getTotalSize(i.slice(0, opts.items.visibleConf.old), opts, "width");
                }
                m && (opts.items[opts.d.width] = v), opts.align && opts.padding[opts.d[1]] < 0 && (opts.padding[opts.d[1]] = 0), 
                sz_resetMargin(i, opts, !0), sz_resetMargin(f, opts, opts.padding[opts.d[1]]), opts.align && (opts.padding[opts.d[1]] = d, 
                opts.padding[opts.d[3]] = p), I[opts.d.left] = opts.usePadding ? opts.padding[opts.d[3]] : 0;
                var j = function() {}, k = function() {}, N = function() {}, T = function() {}, O = function() {}, M = function() {}, F = function() {}, A = function() {}, H = function() {};
                switch (e.fx) {
                  case "crossfade":
                  case "cover":
                  case "cover-fade":
                ...
                if (scrl = sc_setScroll(z, e.easing, conf), P[opts.d.left] = -h, x[opts.d.left] = -S, 
                0 > p && (P[opts.d.left] += p), ("variable" == opts[opts.d.width] || "variable" == opts[opts.d.height]) && (j = function() {
                    $wrp.css(w);
                }, k = function() {
                    scrl.anims.push([ $wrp, w ]);
                }), opts.usePadding) {
                    var q = u.data("_cfs_origCssMargin");
                    d >= 0 && (q += opts.padding[opts.d[1]]), u.css(opts.d.marginRight, q), l.not(f).length && (y[opts.d.marginRight] = f.data("_cfs_origCssMargin")), 
                    N = function() {
                        f.css(y);
                    }, T = function() {
                        scrl.anims.push([ f, y ]);
                    ...
                    p > 0 && (D += opts.padding[opts.d[3]]), C[opts.d.marginRight] = D, O = function() {
                        l.css(C);
                    }, M = function() {
                        scrl.anims.push([ l, C ]);
                    };
                ...
                var R = opts.items.visible + s - itms.total;
                A = function() {
                    R > 0 && $cfs.children().slice(itms.total).remove();
                    var t = $cfs.children().slice(0, s).appendTo($cfs).last();
                    if (R > 0 && (c = gi_getCurrentItems(i, opts)), sc_showHiddenItems(m), opts.usePadding) {
                ...
                var V = sc_mapCallbackArguments(a, _, c, s, "next", z, w);
                switch (F = function() {
                    $cfs.css("zIndex", $cfs.data("_cfs_origCssZindex")), sc_afterScroll($cfs, b, e), 
                    crsl.isScrolling = !1, clbk.onAfter = sc_fireCallbacks($tt0, e, "onAfter", V, clbk), 
                    queu = sc_fireQueue($cfs, queu, conf), crsl.isPaused || $cfs.trigger(cf_e("play", conf));
                }, crsl.isScrolling = !0, tmrs = sc_clearTimers(tmrs), clbk.onBefore = sc_fireCallbacks($tt0, e, "onBefore", V, clbk), 
                e.fx) {
                  case "none":
                    $cfs.css(P), j(), N(), O(), H(), A(), F();
                    break;
                  ...
                  case "fade":
                    scrl.anims.push([ $cfs, {
                        ...
                        j(), N(), O(), H(), A(), scrl = sc_setScroll(z, e.easing, conf), scrl.anims.push([ $cfs, {
                            opacity: 1
                  ...
                  case "cover":
                    $cfs.css(opts.d.left, $wrp[opts.d.width]()), scrl.anims.push([ $cfs, I, F ]), k(), 
                    N(), O(), A();
                    break;
                  ...
                  case "cover-fade":
                    $cfs.css(opts.d.left, $wrp[opts.d.width]()), scrl.anims.push([ b, {
                        opacity: 0
                    } ]), scrl.anims.push([ $cfs, I, F ]), k(), N(), O(), A();
                    break;

                  case "uncover":
                    scrl.anims.push([ b, x, F ]), k(), N(), O(), H(), A();
                    break;
                ...
                return sc_startScroll(scrl, conf), cf_setCookie(opts.cookie, $cfs, conf), $cfs.trigger(cf_e("updatePageStatus", conf), [ !1, w ]), 
                !0;
            }), $cfs.bind(cf_e("slideTo", conf), function(t, e, s, i, n, o, r) {
                t.stopPropagation();
                var a = [ e, s, i, n, o, r ], c = [ "string/number/object", "number", "boolean", "object", "string", "function" ], l = cf_sortParams(a, c);
                return n = l[3], o = l[4], r = l[5], e = gn_getItemIndex(l[0], l[1], l[2], itms, $cfs), 
                0 == e ? !1 : (is_object(n) || (n = !1), "prev" != o && "next" != o && (o = opts.circular ? e <= itms.total / 2 ? "next" : "prev" : 0 == itms.first || itms.first > e ? "next" : "prev"), 
                "prev" == o && (e = itms.total - e), $cfs.trigger(cf_e(o, conf), [ n, e, r ]), !0);
            ...
            }), $cfs.bind(cf_e("slideToPage", conf), function(t, e, s, i, n) {
                ...
                return 0 > e && (e = r), e > r && (e = 0), $cfs.triggerHandler(cf_e("slideTo", conf), [ e * o, 0, !0, s, i, n ]);
            }), $cfs.bind(cf_e("jumpToStart", conf), function(t, e) {
                if (t.stopPropagation(), e = e ? gn_getItemIndex(e, 0, !0, itms, $cfs) : 0, e += itms.first, 
                0 != e) {
                ...
                for (var s = $cfs.triggerHandler(cf_e("currentPosition", conf)), i = !0, n = 0, o = e.length; o > n; n++) e[n][0].triggerHandler(cf_e("slideTo", conf), [ s, e[n][3], !0 ]) || (i = !1);
                return i;
            }), $cfs.bind(cf_e("queue", conf), function(t, e, s) {
                return t.stopPropagation(), is_function(e) ? e.call($tt0, queu) : is_array(e) ? queu = e : is_undefined(e) || queu.push([ e, s ]), 
                queu;
            }), $cfs.bind(cf_e("insertItem", conf), function(t, e, s, i, n) {
                t.stopPropagation();
                var o = [ e, s, i, n ], r = [ "string/object", "string/number/object", "boolean", "number" ], a = cf_sortParams(o, r);
                if (e = a[0], s = a[1], i = a[2], n = a[3], is_object(e) && !is_jquery(e) ? e = $(e) : is_string(e) && (e = $(e)), 
                !is_jquery(e) || 0 == e.length) return debug(conf, "Not a valid object.");
                is_undefined(s) && (s = "end"), sz_storeMargin(e, opts), sz_storeOrigCss(e);
                var c = s, l = "before";
                "end" == s ? i ? (0 == itms.first ? (s = itms.total - 1, l = "after") : (s = itms.first, 
                itms.first += e.length), 0 > s && (s = 0)) : (s = itms.total - 1, l = "after") : s = gn_getItemIndex(s, n, i, itms, $cfs);
                var f = $cfs.children().eq(s);
                return f.length ? f[l](e) : (debug(conf, "Correct insert-position not found! Appending item to the end."), 
                $cfs.append(e)), "end" == c || i || s < itms.first && (itms.first += e.length), 
                ...
                t.stopPropagation();
                var n = [ e, s, i ], o = [ "string/number/object", "boolean", "number" ], r = cf_sortParams(n, o);
                e = r[0], s = r[1], i = r[2];
                if (e instanceof $ && e.length > 1) return a = $(), e.each(function(t, e) {
                    var n = $cfs.trigger(cf_e("removeItem", conf), [ $(this), s, i ]);
                    n && (a = a.add(n));
                }), a;
                ...
                return a && a.length && (a.detach(), itms.total = $cfs.children().length, $cfs.trigger(cf_e("updateSizes", conf))), 
                a;
                ...
                t.stopPropagation();
                var s, i = opts.pagination.items || opts.items.visible, n = Math.ceil(itms.total / i - 1);
                return s = 0 == itms.first ? 0 : itms.first < itms.total % i ? 0 : itms.first != i || opts.circular ? Math.round((itms.total - itms.first) / i) : n, 
                0 > s && (s = 0), s > n && (s = n), is_function(e) && e.call($tt0, s), s;
                ...
                var n = [ e, s, i ], o = [ "number", "number", "function" ], r = cf_sortParams(n, o);
                if (e = is_number(r[0]) ? r[0] : 0, s = is_number(r[1]) ? r[1] : itms.total, i = r[2], 
                e += itms.first, s += itms.first, items.total > 0) {
                ...
                return a = s > e ? c.slice(e, s) : $(c.slice(e, itms.total).get().concat(c.slice(0, s).get())), 
                is_function(i) && i.call($tt0, a), a;
                ...
                return t.stopPropagation(), is_undefined(e) ? e = $("body") : is_string(e) && (e = $(e)), 
                is_jquery(e) && 0 != e.length ? (is_string(s) || (s = "a.caroufredsel"), e.find(s).each(function() {
                    var t = this.hash || "";
                ...
                if (t.stopPropagation(), opts.pagination.container) {
                    var i = opts.pagination.items || opts.items.visible, n = Math.ceil(itms.total / i);
                ...
                var e = opts.items.visible, s = $cfs.children(), i = ms_getParentSize($wrp, opts, "width");
                if (itms.total = s.length, crsl.primarySizePercentage ? (opts.maxDimension = i, 
                ...
                opts = in_getResponsiveValues(opts, s, i), e = opts.items.visible, sz_setResponsiveSizes(opts, s)) : opts.items.visibleConf.variable ? e = gn_getVisibleItemsNext(s, opts, 0) : "*" != opts.items.filter && (e = gn_getVisibleItemsNextFilter(s, opts, 0)), 
                !opts.circular && 0 != itms.first && e > itms.first) {
                    if (opts.items.visibleConf.variable) var n = gn_getVisibleItemsPrev(s, opts, itms.first) - itms.first; else if ("*" != opts.items.filter) var n = gn_getVisibleItemsPrevFilter(s, opts, itms.first) - itms.first; else var n = opts.items.visible - itms.first;
                    debug(conf, "Preventing non-circular: sliding " + n + " items backward."), $cfs.trigger(cf_e("prev", conf), n);
                }
                opts.items.visible = cf_getItemsAdjust(e, opts, opts.items.visibleConf.adjust, $tt0), 
                opts.items.visibleConf.old = opts.items.visible, opts = in_getAlignPadding(opts, s);
                var o = sz_setSizes($cfs, opts);
                return $cfs.trigger(cf_e("updatePageStatus", conf), [ !0, o ]), nv_showNavi(opts, itms.total, conf), 
                nv_enableNavi(opts, itms.first, conf), o;
            }), $cfs.bind(cf_e("destroy", conf), function(t, e) {
                return t.stopPropagation(), tmrs = sc_clearTimers(tmrs), $cfs.data("_cfs_isCarousel", !1), 
                $cfs.trigger(cf_e("finish", conf)), e && $cfs.trigger(cf_e("jumpToStart", conf)), 
            ...
            if (opts.auto.button && opts.auto.button.bind(cf_e(opts.auto.event, conf, !1), function(t) {
                t.preventDefault();
                var e = !1, s = null;
                crsl.isPaused ? e = "play" : opts.auto.pauseOnEvent && (e = "pause", s = bt_pauseOnHoverConfig(opts.auto.pauseOnEvent)), 
            ...
            if ((opts.prev.key || opts.next.key) && $(document).bind(cf_e("keyup", conf, !1, !0, !0), function(t) {
                var e = t.keyCode;
                e == opts.next.key && (t.preventDefault(), $cfs.trigger(cf_e("next", conf))), e == opts.prev.key && (t.preventDefault(), 
                $cfs.trigger(cf_e("prev", conf)));
            }), opts.pagination.keys && $(document).bind(cf_e("keyup", conf, !1, !0, !0), function(t) {
                var e = t.keyCode;
                e >= 49 && 58 > e && (e = (e - 49) * opts.items.visible, e <= itms.total && (t.preventDefault(), 
                $cfs.trigger(cf_e("slideTo", conf), [ e, 0, !0, opts.pagination ])));
            }), $.fn.swipe) {
                var e = "ontouchstart" in window;
                if (e && opts.swipe.onTouch || !e && opts.swipe.onMouse) {
                    var s = $.extend(!0, {}, opts.prev, opts.swipe), i = $.extend(!0, {}, opts.next, opts.swipe), n = function() {
            ...
            $wrp.unbind(t), opts.auto.button && opts.auto.button.unbind(t), opts.prev.button && opts.prev.button.unbind(t), 
            opts.next.button && opts.next.button.unbind(t), opts.pagination.container && (opts.pagination.container.unbind(t), 
        ...
        get: function(t) {
            ...
            for (var e = document.cookie.split(";"), s = 0, i = e.length; i > s; s++) {
                for (var n = e[s]; " " == n.charAt(0); ) n = n.slice(1);
        ...
        set: function(t, e, s) {
            ...
            if (s) {
                var n = new Date();
                n.setTime(n.getTime() + 24 * s * 60 * 60 * 1e3), i = "; expires=" + n.toGMTString();
            }
